...
/*
 * Defined triangle class
 */
public class Triangle {
    //vertexShaderCode is for drawing shape.
    //fragmentShaderCode is for coloring shape
    ...
    String strColor = "#FFFFFF";// Hex code of white
    int intColor = Color.parseColor(strColor);
    float color[] = { Color.red(intColor) / 255.0f,
            Color.green(intColor) / 255.0f,
            Color.blue(intColor) / 255.0f, 1.0f};//White color
